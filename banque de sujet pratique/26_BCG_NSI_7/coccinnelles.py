...
class Coccinelle:
    ...
    def chasser(self, nb_proies, nb_coccinelles):
        """
        nb_proies permet de savoir le nombre de proies.
        nb_coccinelles permet de savoir le nombre de coccinelles.
        si la coccinelles consomme au moin 10 proies, son niveau
        nutrition augmente de 1.
        si elle ne mange pas alors son nutrition dimunue de 1.
...
#############################################################################
population = [
    Coccinelle("femelles", 10, 2),
    Coccinelle("femelles", 10, 2),
    Coccinelle("mâles", 10, 2)
]
...
for i in range(5):
    ...
    print("Nombre de coccinelles :"+ str(len(population)) + " ; " + "Nombre de proies :" + str(nb_proies))
...
def simulation_simple(population, nb_proies):
    ...
    for i in range(30):
    population, nb_proies = evolution(population, nb_proies)
    if population == 0 or nb_proies == 0:
        return(population, nb_proies, i)
    
    return ( population, nb_proies, jour)
